...
const Footer = () => {
  return (
    <div className="bg-gray-900 mt-10 lg:mt-20">
      <footer className="footer w-5/6 mx-auto justify-start md:justify-around text-base-content p-16">
        <nav>
          <h6 className="font-bold text-base text-white">Services</h6>
        ...
        <nav>
          <h6 className="font-bold text-base text-white">Legal</h6>
      ...
      <footer className="footer w-5/6 mx-auto bg-gray-900  text-base-content border-gray-500 border-t px-10 py-10">
        <aside className="grid-flow-col items-center">
          <img src={logo} className="w-10 h-10" alt="" />
          <p className="text-gray-500">
            ProdRec Industries Ltd.
            <br />
